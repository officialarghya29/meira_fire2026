...
Metric for the matrices: **nDCG@10** (paired t-test, two-sided). p-values are **bonferroni-corrected** for the family of all 28 pairwise tests per dataset. `*` p<0.05, `**` p<0.01, `***` p<0.001.
...
|---|---|---|---|---|---|---|---|---|
| BM25 | — | 0.2927 | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| TF-IDF |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| Dense-IR |  |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| ColBERT-like |  |  |  | — | 0.0004*** | 0.1979 | <0.0001*** | <0.0001*** |
| MEIRA-no-memory |  |  |  |  | — | 0.0024** | <0.0001*** | <0.0001*** |
...
| TF-IDF |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| Dense-IR |  |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| ColBERT-like |  |  |  | — | 0.0266* | 0.0215* | 0.0037** | <0.0001*** |
| MEIRA-no-memory |  |  |  |  | — | 0.0020** | 0.0020** | <0.0001*** |
| MEIRA-no-decay |  |  |  |  |  | — | 0.0093** | <0.0001*** |
| MEIRA-no-xai |  |  |  |  |  |  | — | 0.0012** |
| MEIRA-full |  |  |  |  |  |  |  | — |
