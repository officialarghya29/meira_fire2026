...
Metric for the matrices: **MAP** (paired t-test, two-sided). p-values are **bonferroni-corrected** for the family of all 28 pairwise tests per dataset. `*` p<0.05, `**` p<0.01, `***` p<0.001.

## FIRE-AgentIR-2026

Significant pairs at α=0.05: **28/28 raw** → **26/28** after bonferroni correction.

| Model | BM25 | TF-IDF | Dense-IR | ColBERT-like | MEIRA-no-memory | MEIRA-no-decay | MEIRA-no-xai | MEIRA-full |
|---|---|---|---|---|---|---|---|---|
| BM25 | — | 0.0946 | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| TF-IDF |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| Dense-IR |  |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| ColBERT-like |  |  |  | — | 0.0003*** | 0.1241 | <0.0001*** | <0.0001*** |
| MEIRA-no-memory |  |  |  |  | — | 0.0016** | <0.0001*** | <0.0001*** |
...
Significant pairs at α=0.05: **28/28 raw** → **27/28** after bonferroni correction.

| Model | BM25 | TF-IDF | Dense-IR | ColBERT-like | MEIRA-no-memory | MEIRA-no-decay | MEIRA-no-xai | MEIRA-full |
|---|---|---|---|---|---|---|---|---|
| BM25 | — | 0.6907 | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| TF-IDF |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| Dense-IR |  |  | — | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** | <0.0001*** |
| ColBERT-like |  |  |  | — | 0.0247* | 0.0148* | 0.0042** | <0.0001*** |
| MEIRA-no-memory |  |  |  |  | — | 0.0019** | 0.0025** | <0.0001*** |
| MEIRA-no-decay |  |  |  |  |  | — | 0.0135* | <0.0001*** |
| MEIRA-no-xai |  |  |  |  |  |  | — | 0.0007*** |
| MEIRA-full |  |  |  |  |  |  |  | — |
