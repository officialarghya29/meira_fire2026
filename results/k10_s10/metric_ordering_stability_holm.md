...
Ranks: 1 = best mean. Adjacent pairs marked with `†` are **not** significantly different — p-values are **holm-corrected** for the family of all 28 pairwise tests per metric × dataset (p ≥ 0.05 after correction) — the places where the ordering could flip.
...
**F1:**
| Higher | Lower | Δ mean | t | p raw | p (holm) | sig |
|---|---|---|---|---|---|---|
...
| MEIRA-no-decay | ColBERT-like | +0.0038 | 3.468 | 0.0071 | 0.0141 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0065 | 8.461 | <0.0001 | 0.0001 | yes |
| MEIRA-no-memory | Dense-IR | +0.0291 | 18.339 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.0915 | 21.559 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0031 | 3.222 | 0.0105 | 0.0141 | yes |
...
| MEIRA-no-decay | ColBERT-like | +0.0056 | 3.768 | 0.0044 | 0.0068 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0095 | 8.596 | <0.0001 | <0.0001 | yes |
| MEIRA-no-memory | Dense-IR | +0.0416 | 19.831 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.1255 | 22.037 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0048 | 3.946 | 0.0034 | 0.0068 | yes |
...
| MEIRA-no-decay | ColBERT-like | +0.0030 | 2.720 | 0.0236 | 0.0472 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0051 | 6.390 | 0.0001 | 0.0005 | yes |
| MEIRA-no-memory | Dense-IR | +0.0239 | 14.111 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.0823 | 19.793 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0012 | 1.018 | 0.3351 | 0.3351† | no |
...
| BM25 | TF-IDF | +0.0101 | 5.758 | 0.0003 | 0.0003 | yes |

**nDCG@10:**
| Higher | Lower | Δ mean | t | p raw | p (holm) | sig |
|---|---|---|---|---|---|---|
| MEIRA-full | MEIRA-no-xai | +0.0171 | 7.399 | <0.0001 | 0.0003 | yes |
| MEIRA-no-xai | MEIRA-no-decay | +0.0082 | 5.607 | 0.0003 | 0.0013 | yes |
| MEIRA-no-decay | ColBERT-like | +0.0044 | 4.973 | 0.0008 | 0.0023 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0103 | 4.819 | 0.0009 | 0.0023 | yes |
| MEIRA-no-memory | Dense-IR | +0.0259 | 13.369 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.0789 | 21.491 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0021 | 2.316 | 0.0458 | 0.0458 | yes |

**MAP:**
| Higher | Lower | Δ mean | t | p raw | p (holm) | sig |
|---|---|---|---|---|---|---|
| MEIRA-full | MEIRA-no-xai | +0.0245 | 7.825 | <0.0001 | 0.0002 | yes |
| MEIRA-no-xai | MEIRA-no-decay | +0.0113 | 5.316 | 0.0005 | 0.0019 | yes |
| MEIRA-no-decay | ColBERT-like | +0.0062 | 5.251 | 0.0005 | 0.0019 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0140 | 4.873 | 0.0009 | 0.0019 | yes |
| MEIRA-no-memory | Dense-IR | +0.0357 | 13.844 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.1075 | 21.422 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0031 | 2.693 | 0.0247 | 0.0247 | yes |

**MRR:**
| Higher | Lower | Δ mean | t | p raw | p (holm) | sig |
|---|---|---|---|---|---|---|
| MEIRA-full | MEIRA-no-xai | +0.0117 | 6.268 | 0.0001 | 0.0009 | yes |
| MEIRA-no-xai | MEIRA-no-decay | +0.0061 | 6.055 | 0.0002 | 0.0009 | yes |
| MEIRA-no-decay | ColBERT-like | +0.0028 | 4.211 | 0.0023 | 0.0045 | yes |
| ColBERT-like | MEIRA-no-memory | +0.0077 | 4.736 | 0.0011 | 0.0032 | yes |
| MEIRA-no-memory | Dense-IR | +0.0189 | 11.975 | <0.0001 | <0.0001 | yes |
| Dense-IR | BM25 | +0.0593 | 22.633 | <0.0001 | <0.0001 | yes |
| BM25 | TF-IDF | +0.0011 | 1.550 | 0.1554 | 0.1554† | no |
